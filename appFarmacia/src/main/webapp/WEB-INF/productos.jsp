            ...
            <table class = "table table-striped table-hover">
                <thead class="table-dark">
                    <tr>
                        ...
                        <td colspan = "2" style="text-align: center"><strong><a class="btn btn-info" style="color: black" href="nuevoProducto">NUEVO</a></strong></td>
                    </tr>
                </thead>
                ...
                <tbody>
                    ...
                    <tr>
                        <td class="blockquote"><%=x.getNOMBRE()%></td>
                        <td class="blockquote"><%=x.getCANTIDAD()%></td>
                        <td class="blockquote"><%=x.getPRECIO_VENTA()%></td>
                        <td class="blockquote"><%=x.getPRECIO_COMPRA()%></td>
                        <td ><A href="editarProducto?id=<%=x.getIDPRODUCTO()%>"><button><i class="fa-solid fa-pen-to-square"></i><h6>Editar</h6></button></A></td>
                        <td><A onclick= "return confirm('¿SEGURO QUE DESEA ELIMINAR?')" href="eliminarProducto?id=<%=x.getIDPRODUCTO()%>"><button><i class="fa-solid fa-trash-can"></i><h6>Eliminar</h6></button></A></td>
                    </tr>
                    <%}%>
                </tbody>
            </table>
