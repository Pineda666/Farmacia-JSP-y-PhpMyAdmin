...
<html>
    ...
    <body>
        ...
        <% ArrayList<compraProducto> lista = (ArrayList<compraProducto>) request.getAttribute("facturas"); %>
            ...
            <table class = "table table-striped table-hover">
                <thead class="table-dark">
                    <tr>
                        ...
                        <td><strong>Total Monetario</strong></td>
                ...
                <tbody>
                    ...
                    <tr>
                        <td class="blockquote"><%=x.getIDCOMPRAPRODUCTO() %></td>
